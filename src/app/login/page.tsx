          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <form onSubmit={handleLogin} className="rounded pt-6 pb-8 mb-4 ml-0">
              ...
              <div className="flex items-center justify-between mt-6">
                <button
                  type="submit"
                  className="bg-cyan-500 hover:bg-blue-700 text-white font-bold w-full py-2 px-3 rounded focus:outline-none focus:shadow-outline"
                >
                  Login
                </button>
              </div>
              <div className="text-center mt-4">
                <span>Don't have an account?</span><a href="/register" className="inline-block align-baseline font-bold text-sm text-cyan-500 hover:text-blue-800">
                  Register
                </a>
              </div>
            </form>
